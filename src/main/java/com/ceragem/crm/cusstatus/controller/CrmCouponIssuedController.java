...
import com.ceragem.crm.cusstatus.service.CrmCouponIssuedService;

import lombok.RequiredArgsConstructor;

@Controller
@RequestMapping(value = { "couponIssued" })
@RequiredArgsConstructor
public class CrmCouponIssuedController {
	private final CrmCouponIssuedService service;

	@GetMapping(value = { "", "index" })
	public String init(Model model) throws Exception {
		// model.addAttribute("barLabels", service.barLabels());//
		// model.addAttribute("barData", service.barData());//
		return Utilities.getProperty("tiles.crm") + "cusStatus/couponIssued";
	}
