...
import com.ceragem.crm.cst.model.CrmCustBasCompanyListVo;
import com.ceragem.crm.main.service.CrmCustBasService;

/**
 * 
 * @ClassName    CrmCustBasCompanyListController
 * @author    user
 * @date    2022. 4. 19.
 * @Version    1.0
...
@Controller
@RequestMapping(value = { "crmCustCompany", "{menuCd}/crmCustCompany" })
public class CrmCustBasCompanyListController{
...
public String init(@RequestParam Map<String, Object> param, ModelMap model) throws Exception {
    ...
    return Utilities.getProperty("tiles.crm") + "cst/CR003";
}
...
public @ResponseBody Object save(@RequestBody CrmCustBasCompanyListVo vo) throws Exception {
...
public @ResponseBody Object saveList(@RequestBody List<CrmCustBasCompanyListVo> list) throws Exception {
...
public @ResponseBody Object deleteList(@RequestBody List<CrmCustBasCompanyListVo> list) throws Exception {
