...
/**
 * 
 * @ClassName    BlackCusVo
 * @author    황의겸
 * @date    2022. 5. 3.
 * @Version    1.0
 * @description    CRM블랙고객이력 Vo
 * @Company    Copyright ⓒ wigo.ai. All Right Reserved
 */
@Getter
@Setter
public class BlackCusVo extends BaseVo {
    /**
    *
    */
