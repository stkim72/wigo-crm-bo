...
<div class="mBox1">
			...
			<form role="form" id="frmSearch">
								<table>
									...
									<tbody>
										<tr>
											<th scope="row" class="left">로그인일</th>
											<td>
 ...
 <div class="gTitle1 ">
								...
								<div class="gRt">
									<code:btnGroup name="ApiHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="로그인이력" gridId="grdList"/>
								</div>
			</div>
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/user/loginHist.xml'/>"
				>
