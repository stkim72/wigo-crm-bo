...
<form role="form" id="frmSearch">
			<ul >
				<li class="w100per">
					 <div class="tit" style="width: 10%;">검색어</div>
                     ...
                     <div class="tit" style="width: 10%;">검색어</div>
                     <div class="txt" style="width:20%">
<%--                      <code:commCode codeCd="" codeType="storeNo" select2="true" prefixLabel="전체"/> --%>
                    <input type="text" id="storNos" readonly data-type="storeSelect" value='139908,139535,139288,137377,139413,139416'/>
                     </div>
                      					 <div class="tit" style="width: 40%;">
                      					 <div class="tit" style="width: 40%;">
                                         <a href="#" class="mBtn1" data-click="clearItem" >clear</a>
                                         <a href="#" class="mBtn1" data-click="setItem" >setItem</a>
...
function clearItem(){
	 var selectize = $("#storNos")[0].selectize;
     selectize.clear();
     selectize.clearOptions();
}
function setItem(){
	const v = '139908,139535,139288,137377,139908,139535,139288,137377';
	var selectize = $("#storNos")[0].selectize;
	var storeMap = $("#storNos")[0].storeMap;
    selectize.clear();
    selectize.clearOptions();
    const arr = v.split(",");
    const opts = [];
    ...
    for(var i = 0 ;i< arr.length;i++){
    	if(optsMap[arr[i]])
    		continue;
    	opts.push(storeMap[arr[i]]);
    }
    selectize.addOption(opts);
    selectize.setValue(arr);
}
