...
<div class="title">
 ...
 <input type="hidden" id="batchCd" name="batchCd" value="${batchCd }" />
<div class="mSort2">
...
<!--                      </div> -->
                     ...
                     <div class="txt" style="width:6%">
                        <input type="text" id="batchCallUrlLike" data-enter="search" name="batchCallUrlLike" class="it" placeholder="URL">
                     </div>
...
<div class="mBox1 btnTopMargin">
        <div class="gTitle1">
            ...
            <div class="gRt">
                <code:btnGroup name="BatchHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="BATCH실행로그" gridId="grdList"/>
            </div>
        </div>
        
        <div id="divGrid"  style="height:450px" data-grid-id="grdList" 
                                        data-pagenation="Y" 
                                        data-get-url="<c:url value='${urlPrefix}/batchHist/getList${urlSuffix}'/>" 
                                        data-type="grid" 
...
function search()
{
    var url = "<c:url value='${urlPrefix}/batchHist/getList${urlSuffix}'/>";
