...
<div class="gTitle1">
			<h3 class="mTitle1">첨부파일</h3>
				<div class="gRt">
					<a href="#;" data-grid-id="grdList" data-click="newFileInfo" id="btnUpload" class="mBtn1 m lWhite" > upload</a>
<!-- 	            <a href="#;" data-grid-id="grdList" data-click="downloadFile" id="btnDownload" class="mBtn1 m lWhite"> 다운로드</a> -->
<!-- 	            <a href="#;" data-grid-id="grdList" data-click="removeFile" id="btnDelList" data-action="del" class="mBtn1 m lWhite">삭제</a> -->
				</div>
		</div>
 	<div id="divGrid"   data-grid-id="grdList" data-get-url="<c:url value='${urlPrefix}/getList'/>${urlSuffix}" data-pagenation="Y" data-type="grid" data-grid-callback="onGridLoad" data-tpl-url="<c:url value='/static/gridTemplate/file/fileInfo.xml'/>">
    		</div>
