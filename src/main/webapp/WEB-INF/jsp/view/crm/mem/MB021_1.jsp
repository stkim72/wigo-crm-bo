                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th class="left" scope="row">발행일시</th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <code:commCode id="pblsDivCd" name="pblsDivCd" codeCd="EV100" prefixLabel=" " prefixValue="" selectedValue="${PointIssue.pblsDivCd}" />
                                </td>
                            ...
                            <tr>
                                ...
                                <th class="left" scope="row">유효기간만료일</th>
                                <td>
                                   <input type="text" class="it" id="validPerdEndYmd" name="validPerdEndYmd" value="${PointIssue.validPerdEndYmd}" readonly/>
                                </td>
                            </tr>
                            <tr>
