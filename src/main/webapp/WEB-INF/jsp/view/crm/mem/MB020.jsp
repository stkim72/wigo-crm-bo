...
<div id="wrapIframe" class="closed"> <!-- 고객정보 닫힘 -->
	...
	<div class="mGrid1">
		...
		<div class="gRight">
            ...
            <!-- <input type="hidden" id="itgCustNo" name="itgCustNo"/>     -->
				<ul>
					...
					<li class="w15per">
						...
						<div class="txt">
							<input type="text" class="it" id="itgCustNo" name="itgCustNo" placeholder="통합고객번호" />
						</div>
					</li>
					<li class="w15per">
						<div class="tit">캠페인번호</div>
						<div class="txt">
							<input type="text" class="it" id="campNo" name="campNo" placeholder="캠페인번호" />
						</div>
					</li>
				</ul>
				...
				<ul>
					...
					<li class="w15per">
						...
						<div class="txt">
							<span class="flex"><input type="text" class="it" id="chitNo" name="chitNo" placeholder="전체" title="채널코드"></span>
						</div>
					</li>
					<div class="right">
			...
			<div class="gTitle1">
		    	<h3 class="mTitle1">포인트 발생 목록</h3>
		    	<div class="gRt">
					<code:btnGroup name="pointList" hideDelete="true" hideInsert="true" hideSave="true" dispName="포인트 발생 목록" gridId="grdList"/>
				</div>
			</div>
			...
			<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                    	...
                    	data-block-ui="Y"
			                                        ...
			                                        data-tpl-url="<c:url value='/static/gridTemplate/mem/MB020.xml'/>"
			>
			</div>
...
function showDetail(json){
    ...
    Utilities.openModal(url,1000,280);
}
...
function updateOccurPointScore(strOccurPointScore){
	...
	saveJson[0].pblsDt = null;
	saveJson[0].useDt = null;
	saveJson[0].extncDt = null;
