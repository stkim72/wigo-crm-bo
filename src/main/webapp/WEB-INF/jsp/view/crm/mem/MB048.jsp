				...
				<div class="mSort2 mini">
					...
					<ul>
						...
						<li class="">
							...
							<div class="txt">
								<input type="text" class="it w130" title="채널명" placeholder="채널 검색"  name="applyChlCdNm" id="applyChlCdNm" value="${applyChlCdNm}" >
				...
				<div class="mSort2 mini">
					...
					<ul>
						...
						<li class="">
							<div class="tit">채널명</div>
							<div class="txt">
								<input type="text" class="it w130" title="채널명" placeholder="채널명 검색"  name="applyChlCdNm2" id="applyChlCdNm2" value="${applyChlCdNm2}" >
							</div> <button type="submit" class="mBtn1" data-click="search()" onclick="search()">검색</button>
