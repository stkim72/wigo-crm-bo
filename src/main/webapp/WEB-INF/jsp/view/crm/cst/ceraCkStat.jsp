...
<div id="wrapIframe" class="closed"> <!-- 고객정보 닫힘 -->
	<div class="cont">
		<div class="gTitle1 line">
		    <h3 class="mTitle1">세라체크 측정 고객 통계 검색</h3>
		</div>
		...
		<div class="gTitle1">
			<h3 class="mTitle1">세라체크 측정 고객 통계 목록 ( 성별분포 )</h3>
			<div class="gRt">
		...
		<div id="divGrid"  style="height:121px"
			...
			data-pagenation="N" 
			data-get-url="<c:url value='${urlPrefix}/getCeraCkStat1List${urlSuffix}'/>" 
			data-type="grid" 
			data-block-ui="Y"
			data-grid-callback="onGridLoad" 
			data-tpl-url="<c:url value='/static/gridTemplate/cst/ceraCkStat_1.xml'/>">
		</div>
		
		<div class="gTitle1">
            <h3 class="mTitle1">세라체크 측정 고객 통계 목록 ( 연령분포 )</h3>
            <div class="gRt">
        ...
        <div id="divGrid2"  style="height:121px"
            ...
            data-pagenation="N" 
            data-get-url="<c:url value='${urlPrefix}/getCeraCkStat2List${urlSuffix}'/>" 
            data-type="grid" 
            data-block-ui="Y"
            data-grid-callback="onGridLoad" 
            data-tpl-url="<c:url value='/static/gridTemplate/cst/ceraCkStat_2.xml'/>">
        </div>
        
        <div class="gTitle1">
            <h3 class="mTitle1">세라체크 측정 고객 통계 목록 ( 일별측정회원 )</h3>
            <div class="gRt">
        ...
        <div id="divGrid3"  style="height:296px"
            ...
            data-pagenation="N" 
            data-get-url="<c:url value='${urlPrefix}/getCeraCkStat3List${urlSuffix}'/>" 
            data-type="grid" 
            data-block-ui="N"
            data-grid-callback="onGridLoad" 
            data-tpl-url="<c:url value='/static/gridTemplate/cst/ceraCkStat_3.xml'/>">
        </div>
...
{
    var url = "<c:url value='${urlPrefix}/getCeraCkStat1List${urlSuffix}'/>";
    var param = Utilities.formToMap("frmSearch");
    grdList.loadUrl(url,param);
}
function searchGrid2()
{
    var url = "<c:url value='${urlPrefix}/getCeraCkStat2List${urlSuffix}'/>";
    var param = Utilities.formToMap("frmSearch");
    grdList2.loadUrl(url,param);
}
function searchGrid3()
{
    var url = "<c:url value='${urlPrefix}/getCeraCkStat3List${urlSuffix}'/>";
    var param = Utilities.formToMap("frmSearch");
