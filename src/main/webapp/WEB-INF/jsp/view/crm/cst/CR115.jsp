	...
	<div class="cont">
        ...
        <div class="mGrid2">
            	<div class="gTitle1 line">
		            <h3 class="mTitle1">추천고객 정보</h3>
		        </div>
		        
				<!-- board -->
                <div class="mBoard2"> 
                    <table>
                        <caption>추천고객 정보</caption>
                         <colgroup>
                         	<col width="15%">
                            <col width="25%">
                            <col width="15%">
                ...
                <div class="gTitle1 line">
		            <h3 class="mTitle1">추천고객 추천 이력 상세목록</h3>
		        </div>
                <div class="mGrid2">
					<div  id="divGrid" style="height:${rightBoxHeight2}" data-grid-id="grdList" 
					     ...
					     data-tpl-url="<c:url value='/static/gridTemplate/cst/CR115.xml'/>">
					</div>
				</div>
...
function search()
{
    ...
    param.saleTyCd = '${saleTyCd}';
     */
    var url = "<c:url value='${urlPrefix}/selectDetail${urlSuffix}'/>";
