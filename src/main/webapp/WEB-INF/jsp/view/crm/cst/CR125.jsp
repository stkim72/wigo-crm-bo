...
<div class="mPopup1">
	...
	<div class="cont">
        ...
        <div class="mGrid2">
                ...
                <div class="gTitle1 line">
		            <h3 class="mTitle1">충성고객 구매 이력 상세목록</h3>
		        </div>
                <div class="mGrid2">
					<div  id="divGrid" style="height:${rightBoxHeight2}" data-grid-id="grdList" 
					     ...
					     data-tpl-url="<c:url value='/static/gridTemplate/cst/CR125.xml'/>">
					</div>
				</div>
...
function search()
{
     ...
     */
    var url = "<c:url value='${urlPrefix}/selectBosCntrtDetail${urlSuffix}'/>";
