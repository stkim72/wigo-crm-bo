		...
		<div class="mGrid2 type2">
			...
			<div class="lt">
				...
				<div class="mSort2 mini">
					...
					<input type="hidden" class="it w185 basNo" name="mshipStmpBasNo" id="mshipStmpBasNo"   value="${mshipStmpBasNo}" title="쿠폰마스터">
					<input type="hidden" class="it w185 basNo" name="mshipPlcyBasNo" id="mshipPlcyBasNo"   value="${mshipPlcyBasNo}" title="쿠폰마스터">
					...
					<li class="wAuto">
							...
							<div class="txt">
								...
								<code:commCode  className="select" id="storChlCd" name="storChlCd" codeCd="ST040" prefixLabel="전체" prefixValue=""  selectedValue="${storChlCd}" others=" onchange='search()' "/>
						...
						<li class="wAuto">
							...
							<div class="txt">
								...
								<code:commCode  className="select" id="distrctCd" name="distrctCd" codeCd="CU100" prefixLabel="전체" prefixValue=""  selectedValue="${distrctCd}" others=" onchange='search()' "/>
				...
				<div class="mSort2 mini">
					...
					<li class="wAuto">
							...
							<div class="txt">
								...
								<code:commCode  className="select" id="storChlCd2" name="storChlCd2" codeCd="ST040" prefixLabel="전체" prefixValue=""  selectedValue="${storChlCd2}" others=" onchange='search()' "/>
