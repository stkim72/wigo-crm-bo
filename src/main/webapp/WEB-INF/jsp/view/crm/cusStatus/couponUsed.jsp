	...
	<form role="form" id="frmSearchGraph">
			...
			<ul class="searchCon">
				...
				<li class="w30per">
				    ...
				    <div class="tit"><button class="mBtn1" id="dateBtnGraph" data-click="dateClick" style="margin-right: 5px">연도로 전환</button></div>
...
<div class="mSort2">
	<form role="form" id="frmSearch">
			...
			<ul class="searchCon">
				...
				<li class="w30per">
				    <div class="tit">기준일자</div>
				    <div class="tit"><button class="mBtn1" id="dateBtn" data-click="dateClick" style="margin-right: 5px">연도로 전환</button></div>
 	...
 	<div class="gTitle1">
		<h3 class="mTitle1">상세 정보 목록</h3>
			<div class="gRt">
				<code:btnGroup name="excelDown" hideDelete="true" hideInsert="true" hideSave="true" dispName="쿠폰사용내역" gridId="grdList"/>
			</div>
	</div>
 	<div style="height:520px" data-grid-id="grdList"
										...
										data-tpl-url="<c:url value='/static/gridTemplate/cusstatus/couponUsed.xml'/>" >
	</div>
</div>
	...
	if($("#graphTab")[0].classList[0] == "active"){
		...
		barChart = chartDraw('barChartCanvas', 'bar', barLabels, 
    			[{data: barData,
    				...
    				label: '쿠폰 수'}], barOptions('쿠폰사용내역 그래프'));
	}
